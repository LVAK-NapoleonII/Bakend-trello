...
router.delete(
  ...
  authMiddleware,
  activityMiddleware(
    "member_removed_from_card", // actionType
    "member", // category
    "Card", // targetModel
  ...
  router.delete(
    ...
    authMiddleware,
    activityMiddleware("comment_hidden", "member", "Card", (req) => `User ${req.user.fullName} hid a comment`),
    notificationMiddleware(
  ...
  router.delete(
    "/:cardId/notes/:noteId",
    authMiddleware,
    activityMiddleware("note_hidden", "member", "Card", (req) => `User ${req.user.fullName} hid a note`),
    notificationMiddleware(
